                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control input-sm" name="totalPoints"
                                           id="totalPoints"/>
                                </div>
                                <label class="col-sm-2 control-label">结果分析</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control input-sm" name="result" id="result"/>
                                </div>
                            </div>
                        </div>
                    </div>
