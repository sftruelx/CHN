            ...
            <form id="addForm" role="form" class="form-horizontal">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control input-sm" name="testResult"
                                           id="testResult"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">气质结果</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control input-sm" name="temperamentResults" id="temperamentResults"/>
                                </div>
                            </div>
                        </div>
                    </div>
