...
@Entity
@Table(name = "biz_patient_history")
public class BizPatientHistory extends BaseObject implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        final BizPatientHistory bizPatientHistory = (BizPatientHistory) o;

        return !(name != null ? !name.equals(bizPatientHistory.name) : bizPatientHistory.name != null);
