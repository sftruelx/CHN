...
import com.mycompany.dao.sys.UserDao;
import com.mycompany.model.sys.User;
import com.mycompany.service.MailEngine;
import com.mycompany.service.sys.UserExistsException;
import com.mycompany.service.sys.UserManager;
import com.mycompany.service.sys.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.mycompany.service.sys.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.mycompany.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
