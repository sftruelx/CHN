...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.mycompany.service.impl.PasswordTokenManager#generateRecoveryToken(User)
     */
    @Override
    ...
    /**
     * @see com.mycompany.service.impl.PasswordTokenManager#isRecoveryTokenValid(User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.mycompany.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
